...
from .dictation_exercises import evaluar_dictado, DICTATION_EXERCISES
from .reading_exercises import evaluar_lectura, READING_EXERCISES
from .comprehension_exercises import evaluar_comprension, COMPREHENSION_EXERCISES
